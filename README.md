...
Creates a new ASP.NET 5 MVC View Layout Page

Example:

```
yo aspnet:MvcViewLayoutPage _Layout
```

Produces `/_Layout.cshtml`

### MvcViewImportsPage

Creates a new ASP.NET 5 MVC View Imports Page

Example:

```
yo aspnet:MvcViewImportsPage _ViewImports
```
